//View
const microphoneButton = document.querySelector(".start-recording-button")
const recordingControlButtonsContainer = document.querySelector(".recording-contorl-buttons-container")
const stopRecordingButton = document.querySelector(".stop-recording-button")
const cancelRecordingButton = document.querySelector(".cancel-recording-button")
const elapsedTimeTag = document.querySelector(".elapsed-time")
const closeBrowserNotSupportedBoxButton = document.querySelector(".close-browser-not-supported-box")
const overlay = document.querySelector(".overlay")
const audioElement = document.querySelector(".audio-element")
let audioElementSource = document.getElementsByClassName("audio-element")[0]
    .getElementsByTagName("source")[0];
const textIndicatorOfAudiPlaying = document.querySelector(".text-indication-of-audio-playing")
...
function playAudio(recorderAudioAsBlob) {
    ...
    reader.onload = (e) => {
        ...
        downloadBtn.href = base64URL
        downloadBtn.download = prompt('Enter file name...')
        downloadBtn.click()
